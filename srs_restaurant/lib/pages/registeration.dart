...
String pathAsset = 'assets/profile.jpg';
String urlUpload = "http://itschizo.com/aidil_qayyum/srs2/php/register_user.php";
File _image;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Container(padding: EdgeInsets.fromLTRB(40, 0, 40, 20),
